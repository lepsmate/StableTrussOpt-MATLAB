% Stability analysis example of 3D truss structure computed employing frame elements
%
...
sections.A = (15*pi*(ones(nSections,1)*r0).^2)/64 ;                                 % cross section area

for j = 1:nSections
    sections.Iy(j,1) = sections.A(j)^2*113/(60*pi)  ;     % moment of inertia 
end
